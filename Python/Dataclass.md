...
tags:
  ...
  - backend
---
`dataclass` — это инструмент из стандартной библиотеки Python, который автоматически генерирует служебные методы для классов, которые в основном хранят данные.
