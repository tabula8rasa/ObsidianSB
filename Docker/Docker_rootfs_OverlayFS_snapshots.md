...
# Команда для просмотра всего необходимого 

```bash
clear;
eza --tree --level 5 /var/lib/docker/; echo "--------------------------------------------------------"; eza --tree --level 5 /var/lib/containerd/; echo "--------------------------------------------------------"; eza --tree --level 5 /run/docker/; echo "--------------------------------------------------------"; eza --tree --level 5 /run/containerd/;
```
